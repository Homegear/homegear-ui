...
function showIcon(icon) {
    ...
    else if (icon in interfaceData.iconFallback) {
        return `<div class="svg_icon ${interfaceData.iconFallback[icon]}">${icons[interfaceData.iconFallback[icon]]}</div>`;
    }
    else {
        console.warn('Icon is missing: '+icon);
        return `<div class="svg_icon icon_default">
